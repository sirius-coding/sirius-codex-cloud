...
@app.post("/api/v1/invoices", response_model=InvoiceRead, dependencies=[Depends(verify_token)])
...
@app.get("/api/v1/invoices", response_model=list[InvoiceRead], dependencies=[Depends(verify_token)])
def list_records(
...
@app.get("/api/v1/invoices/{record_id}", response_model=InvoiceRead, dependencies=[Depends(verify_token)])
...
@app.patch("/api/v1/invoices/{record_id}", response_model=InvoiceRead, dependencies=[Depends(verify_token)])
def update_record(
    record_id: int,
