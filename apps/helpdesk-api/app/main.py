...
@app.post("/api/v1/tickets", response_model=TicketRead, dependencies=[Depends(verify_token)])
...
@app.get("/api/v1/tickets", response_model=list[TicketRead], dependencies=[Depends(verify_token)])
def list_records(
...
@app.get("/api/v1/tickets/{record_id}", response_model=TicketRead, dependencies=[Depends(verify_token)])
...
@app.patch("/api/v1/tickets/{record_id}", response_model=TicketRead, dependencies=[Depends(verify_token)])
def update_record(
    record_id: int,
