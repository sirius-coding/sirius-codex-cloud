...
@app.post("/api/v1/messages", response_model=MessageRead, dependencies=[Depends(verify_token)])
...
@app.get("/api/v1/messages", response_model=list[MessageRead], dependencies=[Depends(verify_token)])
def list_records(
...
@app.get("/api/v1/messages/{record_id}", response_model=MessageRead, dependencies=[Depends(verify_token)])
...
@app.patch("/api/v1/messages/{record_id}", response_model=MessageRead, dependencies=[Depends(verify_token)])
def update_record(
    record_id: int,
