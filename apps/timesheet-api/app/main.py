...
@app.post("/api/v1/timesheets", response_model=TimesheetRead, dependencies=[Depends(verify_token)])
...
@app.get("/api/v1/timesheets", response_model=list[TimesheetRead], dependencies=[Depends(verify_token)])
def list_records(
...
@app.get("/api/v1/timesheets/{record_id}", response_model=TimesheetRead, dependencies=[Depends(verify_token)])
...
@app.patch("/api/v1/timesheets/{record_id}", response_model=TimesheetRead, dependencies=[Depends(verify_token)])
def update_record(
    record_id: int,
